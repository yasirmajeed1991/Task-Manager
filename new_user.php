                ...
                <div class="row">
                    <div class="col-md-6 border-right">
                        ...
                        <div class="form-group">
                            ...
                            <select name="branch" id="branch" required class="form-control-sm select2">
                                <option></option>
                                <?php 
              	...
              	?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type" required class="form-control-sm select2">
                                <option></option>
                                <option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Processor</option>
                                <option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Loan Cordinator</option>
