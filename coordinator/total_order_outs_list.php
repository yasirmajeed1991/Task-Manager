        ...
        <div class="card-body">
            ...
            <table class="table tabe-hover table-bordered" id="list" style="font-size: 14px;">
                ...
                <tbody style="font-weight: 200;">
					...
					$i = 1;
					$qry = $conn->query("
                    SELECT o.*, s.loan_no_id 
                    FROM order_outs o
                    LEFT JOIN scrub s ON s.id = o.scrub_id
                    LEFT JOIN loan_no ln ON ln.id = s.loan_no_id
                    WHERE JSON_CONTAINS(ln.coordinator, '\"{$_SESSION['login_id']}\"')
                    ");
