            ...
            <div class="container-fluid">
                <form action="" id="manage-loan">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="remarks" id="remarks" cols="30" rows="10" class="summernote form-control" required>
...
$('#manage-loan').submit(function(e) {
    e.preventDefault()
    start_load()
    var input_val = $('#remarks').val();
        if (!input_val) {
            alert('You cannot left the remarks field blank!');
            return false;
        }
    $.ajax({
