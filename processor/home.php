...
<div class="row">
    ...
    <div class="col">
        <a href="./index.php?page=scrub_list">
            <div class="small-box bg-light shadow-sm border">
                <div class="inner">
                    <h3><?php echo $conn->query("SELECT scrub.*
                    FROM scrub
                    INNER JOIN loan_no ON scrub.loan_no_id = loan_no.id
                    WHERE loan_no.processor = '{$_SESSION['login_id']}'")->num_rows; ?></h3>
...
WHERE l.processor = '{$_SESSION['login_id']}'
")->num_rows; ?>
</h3>
                    <p>My Order Outs</p>
                </div>
                ...
                <div class="inner">
                  ...
                  $query = "SELECT *,
                          ...
                          WHERE order_outs.due_date < DATE_SUB('$currentDate', INTERVAL $interval_days DAY)
                              ...
                              AND loan_no.processor = '{$_SESSION['login_id']}'";
