    ...
    <div class="card card-outline card-success">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_scrub"><i
                        class="fa fa-plus"></i> Add New Scrub File</a>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <div class="dropdown-menu" style="">
                                ...
                                <a class="dropdown-item scrub_followup" href="javascript:void(0)"
                                    data-id="<?php echo $row['id'] ?>">Add Follow Up Details</a>
                                ...
                                <a class="dropdown-item "
                                    href="./index.php?page=scrub_follow_up_details&id=<?php echo $row['id'] ?>"
                                     >Edit Follow Up Details</a>

                                <div class="dropdown-divider"></div>

                                <a class="dropdown-item"
                                    href="./index.php?page=view_order&id=<?php echo $row['id'] ?>">View Order Outs
                                    Details</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item"
                                    href="./index.php?page=edit_scrub&id=<?php echo $row['id'] ?>">Edit Scrub</a>

                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item delete_scrub" href="javascript:void(0)"
                                    data-id="<?php echo $row['id'] ?>">Delete Scrub</a>
